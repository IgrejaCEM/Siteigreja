...
async function investigarErro500Final() {
  console.log('🔍 INVESTIGAÇÃO FINAL DO ERRO 500');
  console.log('====================================');
  ...
  try {
    ...
    console.log('📡 [2/6] Verificando servidor...');
    ...
    console.log('📋 Evento:', { id: event.id, title: event.title });
    ...
    console.log('📋 Lote:', { id: lot.id, name: lot.name, price: lot.price, quantity: lot.quantity });
    ...
    console.log('   7. Coluna status inexistente em lots');
  }
}

investigarErro500Final(); 