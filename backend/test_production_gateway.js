...
async function testProductionGateway() {
  try {
    ...
    try {
      ...
      if (PaymentGateway && PaymentGateway.createPayment) {
        ...
        const testPaymentData = {
          amount: 100,
          description: 'Teste Produção Gateway',
          customer: {
            name: 'Teste Produção Gateway',
            email: 'teste@teste.com',
            phone: '11999999999',
            registration_code: 'TEST-PROD-GATEWAY',
            id: 1,
            event_id: 14
          }
        };
