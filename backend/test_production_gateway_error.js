...
async function testProductionGatewayError() {
  try {
    console.log('🧪 Testando erro do PaymentGateway em produção...');
    ...
    try {
      ...
      if (PaymentGateway && PaymentGateway.createPayment) {
        ...
        const testPaymentData = {
          amount: 100,
          description: 'Teste Produção Gateway Error',
          customer: {
            name: 'Teste Produção Gateway Error',
            email: 'teste@teste.com',
            phone: '11999999999',
            registration_code: 'TEST-PROD-GATEWAY-ERROR',
            id: 1,
            event_id: 14
          }
        };
