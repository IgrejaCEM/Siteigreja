...
async function testProductionInitialization() {
  try {
    console.log('🧪 Testando inicialização do PaymentGateway em produção...');
    ...
    try {
      ...
      if (PaymentGateway && PaymentGateway.createPayment) {
        ...
        const testPaymentData = {
          amount: 100,
          description: 'Teste Produção Inicialização',
          customer: {
            name: 'Teste Produção Inicialização',
            email: 'teste@teste.com',
            phone: '11999999999',
            registration_code: 'TEST-PROD-INIT',
            id: 1,
            event_id: 14
          }
        };
