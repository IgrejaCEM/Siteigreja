...
async function testRegistrationControllerProduction() {
  try {
    console.log('🧪 Testando RegistrationController em produção...');
      ...
      if (RegistrationController && RegistrationController.paymentGateway) {
        ...
        if (RegistrationController.paymentGateway.createPayment) {
          ...
          const testPaymentData = {
            amount: 100,
            description: 'Teste RegistrationController Produção',
            customer: {
              name: 'Teste RegistrationController Produção',
              email: 'teste@teste.com',
              phone: '11999999999',
              registration_code: 'TEST-REG-CONTROLLER-PROD',
              id: 1,
              event_id: 14
            }
          };
...
testRegistrationControllerProduction(); 