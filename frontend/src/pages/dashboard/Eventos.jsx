          ...
          <Grid key={evento.id} item xs={12} sm={6} md={4}>
            <Card sx={{ 
              ...
              <CardMedia
                component="img"
                height="200"
                image={evento.banner || "data:image/svg+xml;base64,"}
                alt={evento.title}
                sx={{ objectFit: 'cover' }}
              />
